        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-slate-600">
              Seller: <span className="font-semibold text-slate-800">{resolveDisplayName({ name: sellerName, id: item.pharmacyId, fallback: 'Pharmacy' })}</span>
            </p>
            <p className="mt-2 text-sm text-slate-600">Availability: {item.stock > 0 ? 'In stock' : 'Out of stock'}</p>
