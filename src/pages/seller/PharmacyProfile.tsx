...
const PharmacyProfile: React.FC = () => {
      ...
      try {
        ...
        if (currentPharmacy) {
          setFormData({
            ...
            addressLine: (currentPharmacy.address as any)?.addressLine || (currentPharmacy as any)?.address || '',
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {/* Header / Banner */}
      <div className="relative h-52 bg-gradient-to-r from-emerald-600 to-blue-600 rounded-3xl overflow-hidden shadow-lg shadow-emerald-100">
        <div className="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]" />
        <div className="absolute -bottom-14 left-8 flex items-end gap-6 z-20">
