    ...
    <div className="space-y-8 pb-12">
      {!profileComplete && (
        <div className="bg-amber-50 border border-amber-200 text-amber-800 rounded-xl p-4 text-sm">
          Profile is incomplete (testing mode): seller access is not blocked.
        </div>
      )}
      {pharmacyStatus !== 'verified' && (
        <div className="bg-amber-50 border border-amber-200 text-amber-800 rounded-xl p-4 text-sm">
          Pharmacy status is {pharmacyStatus}. Testing mode keeps dashboard access enabled.
        </div>
      )}
      {!hasInventoryItems && (
        <div className="bg-amber-50 border border-amber-200 text-amber-800 rounded-xl p-4 text-sm">
          No medicines listed yet. You can continue testing and add inventory.
        </div>
      )}
